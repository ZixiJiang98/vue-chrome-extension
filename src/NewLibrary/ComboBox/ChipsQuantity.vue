<template>
  <div 
    ...
    :class="[colorType, { 'disabled': disabled }]"
    :style="`max-width: ${chipsMaxWidth}px;`"
  >
    <div class="flex justify-start items-center gap-2 flex-grow min-w-0">
      <div class="quantity-row flex items-between items-center">
        <div
          :class="disabled ? '' : 'cursor-pointer'" 
          @click="subtractQuantity"
        >
          <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path :class="colorType1Subtract" d="M0 4C0 1.79086 1.79086 0 4 0H16V20H4C1.79086 20 0 18.2091 0 16V4Z" />
            <path :class="colorType2Subtract" d="M4 9H12V11H4V9Z"/>
          </svg>
        </div>
        <div class="quantity flex justify-center items-center">{{ quantity }}</div>
        <div :class="disabled ? '' : 'cursor-pointer'" class="cursor-pointer" @click="addQuantity">
          <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path :class="colorType1Add" d="M0 0H12C14.2091 0 16 1.79086 16 4V16C16 18.2091 14.2091 20 12 20H0V0Z" fill="#99B6C9"/>
            <path :class="colorType2Add" d="M13 10.7329H8.81516V15H7.16407V10.7329H3V9.24699H7.16407V5H8.81516V9.24699H13V10.7329Z" fill="white"/>
          </svg>
...
export default {
  ...
  data() {
    return {
      ...
      isClearHover: false,
      isClearActive: false,
      isSubtractHover: false,
      isSubtractActive: false,
      chipsMaxWidth: 999,
    }
  },
  emits: ["clear", "changeQuantity"],
  computed: {
    colorType1() {
      if (this.disabled) {
